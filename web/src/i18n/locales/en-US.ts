export default {
    ...
    library: {
        title: "Image Library",
        subtitle: "All CC0 / public domain — free for commercial use",
        searchPlaceholder: "Search textures, materials, artworks…",
        empty: "No images matched. Try another keyword.",
        loading: "Loading…",
        loadMore: "Keep scrolling to load more",
        end: "That's everything",
        fetching: "Fetching image…",
        fetchFailed: "Could not fetch the image: {{error}}",
        sourceFailed: "These sources are unavailable right now: {{names}} (other results are unaffected)",
    ...
    account: {
        ...
        usernamePlaceholder: "3-32 characters: letters, digits, underscore",
        passwordPlaceholder: "At least 8 characters, with letters and digits",
        signedInAs: "Signed in",
        notActivated: "This account is not activated yet. Ask the administrator to bind a token before generating.",
        activated: "Activated — the channel has been configured for you",
        ...
        autoSyncHint: "Canvases and assets sync to the cloud automatically after changes",
        insecureWarning: "This site is not on HTTPS, so your password would be sent in clear text. Wait until the domain and certificate are in place before using accounts.",
