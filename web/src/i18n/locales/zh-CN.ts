export default {
    ...
    canvas: {
        ...
        toolbar: {
            select: "选择（左键框选 · 中键移动画布）", pan: "移动（左键拖空白移动画布 · 中键框选 · 中键拖节点也能移动画布）", tidy: "一键整理（选中则只整理选中的）", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", group: "组", extensions: "扩展节点", upload: "上传资产", appearance: "画布外观", clear: "清空画布",
