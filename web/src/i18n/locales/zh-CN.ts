export default {
    ...
    canvas: {
        ...
        toolbar: {
            select: "选择", pan: "移动", tidy: "一键整理（选中则只整理选中的）", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", group: "组", extensions: "扩展节点", upload: "上传资产", appearance: "画布外观", clear: "清空画布",
            colorTone: "色调", hue: "色相", tint: "浓度", resetTone: "恢复默认", brightness: "亮度", themeMode: "主题模式", light: "浅色", dark: "深色", gridStyle: "网格样式", dots: "点", lines: "线", blank: "空白", imageInfo: "图片信息",
        },
        project: {
        ...
        createMenu: { pluginsDescription: "{{count}} 个已安装，悬停展开", plugins: "插件节点", 
        ...
        sidePanel: {
            canvas: "画布", assets: "资产", prompts: "提示词库", library: "素材库", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
    ...
    library: {
        title: "图片素材库",
        subtitle: "全部来自 CC0 / 公有领域，可自由商用",
        searchPlaceholder: "搜索材质、纹理、艺术作品…",
        empty: "没有找到匹配的图片，换个关键词试试",
        loading: "正在加载…",
        loadMore: "继续滚动加载更多",
        end: "已经到底了",
        fetching: "正在获取图片…",
        fetchFailed: "获取图片失败：{{error}}",
        sourceFailed: "以下来源暂时不可用：{{names}}（其余结果不受影响）",
        insert: "插入画布",
    },
    account: {
        title: "账号",
        ...
        passwordPlaceholder: "至少 8 位，需含字母和数字",
        signedInAs: "已登录",
        notActivated: "账号尚未开通。请联系管理员为你绑定令牌，开通后即可生成。",
        activated: "已开通，渠道已自动配置",
        balance: "账户余额",
        totalLabel: "总额",
        usedLabel: "已用",
        storage: "云端空间",
        ...
        autoSyncHint: "画布与资产会在改动后自动同步到云端",
        insecureWarning: "当前站点未启用 HTTPS，密码会以明文传输。请在正式域名和证书就绪后再使用账号功能。",
